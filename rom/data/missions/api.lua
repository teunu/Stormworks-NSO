...
---Called whenever a character picks up another character.
---@param object_id_actor Object_ID The object_id of the character that is performing the pickup action.
---@param object_id_target Object_ID The object_id of the character that has bem picked up.
function onCharacterPickup(object_id_actor, object_id_target) end

---Called whenever a creature sits (or is sat) in a seat or gets on a ladder
---@param object_id Object_ID The object_id of the creature that has sat down
---@param vehicle_id Vehicle_ID The vehicle_id of the vehicle the seat is attached to
---@param seat_name string The name of the seat the creature sat in
function onCreatureSit(object_id, vehicle_id, seat_name) end

---Called whenever a creature gets out of it's seat (or is picked up from their seat) or gets off a ladder
---@param object_id Object_ID The object_id of the creature that has gotten out of the seat
---@param vehicle_id Vehicle_ID The vehicle_id of the vehicle the seat is attached to
---@param seat_name string The name of the seat the creature got out of
function onCreatureUnsit(object_id, vehicle_id, seat_name) end

---Called whenever a character picks up any creature.
---@param object_id_actor Object_ID The object_id of the character that is performing the pickup action.
---@param object_id_target Object_ID The object_id of the character that has bem picked up.
---@param creature_type CREATURE_TYPE The Creature_Type of the creature that was picked up.
function onCreaturePickup(object_id_actor, object_id_target, creature_type) end

---Called whenever a character picks up any equipment.
---@param object_id_actor Object_ID The object_id of the character that is performing the pickup action.
---@param object_id_target Object_ID The object_id of the equipment that has bem picked up.
---@param equipment_id EQUIPMENT_ID The Equipment_Id of the equipment that was picked up.
function onEquipmentPickup(object_id_actor, object_id_target, equipment_id) end

---Called whenever a character picks up any equipment.
---@param object_id_actor Object_ID The object_id of the character that is performing the pickup action.
---@param object_id_target Object_ID The object_id of the equipment that has bem picked up.
---@param equipment_id EQUIPMENT_ID The Equipment_Id of the equipment that was picked up.
function onEquipmentDrop(object_id_actor, object_id_target, equipment_id) end
...
---@param transform Transform The transform where the tornado is spawned.
function onTornado(transform) end

---Called when a meteor is spawned.
---@param transform Transform The transform where the meteor is spawned.
---@param magnitude number The magnitude of the meteor.
function onMeteor(transform, magnitude) end

---Called when a tsunami is spawned.
---@param transform Transform The transform where the tsunami is spawned.
---@param magnitude number The magnitude of the tsunami.
function onTsunami(transform, magnitude) end

---Called when a whirlpool is spawned.
---@param transform Transform The transform where the whirlpool is spawned.
---@param magnitude number The magnitude of the whirlpool.
function onWhirlpool(transform, magnitude) end

---Called when a volcano is spawned.
---@param transform Transform The transform where the volcano is spawned.
...
function server.announce(title, message, peer_id)
	print(string.format("server.announce(%s, %s, %s)", title, message, peer_id or "nil"))
end

---Sends a message to all other scripts. Triggers the onCustomCommand callback with peer_id -1.
...
function server.notify(peer_id, title, message, NOTIFICATION_TYPE)
	print(string.format("server.notify(%s, %s, %s, %s)", peer_id, title, message, NOTIFICATION_TYPE))
end
...
-- todo: the documentation implies that you can make a MapId be removed for multiple players.
...
---Get the index of this addon, or the named addon.
---@param name string|nil The name of the index you want to get the index of. If omitted, this function will get the current addon's index
...
---@param transform nil|Transform optional tile to spawn at, otherwise spawns at the first matching tile.
---@return boolean is_success If the function succeeded
function server.spawnNamedAddonLocation(name, transform) return is_success end
...
---@field tags_full string The tags as a single string, exactly as it was defined in the Playlist Editor.
---@field transform Transform the position, rotation and scale information.
---@field parent_vehicle_id nil|Vehicle_ID The id of the parent vehicle, or nil.
---@field parent_relative_transform nil|Transform The transform, relative to the parent vehicle, or nil.

---Get a table of all active ENV mod zones. You can provide tags separated by commas to only return zones with matching tags.
---@param tag string|nil tag to be used as filter. Official documentation suggests that you can use multiple tags but this does not appear to work???
...
---}
---```
function server.getZones(tag) return zone_list end
...
---@param parent_vehicle_id Vehicle_ID The vehicle_id of the parent vehicle (fire will be attached to the vehicle), or 0 to not attach.
...
---Spawns an animal/creature. Requires Industrial Frontier DLC Enabled.
---@param matrix Transform The matrix to spawn the animal at.
---@param animal_type number The type of animal to spawn
---@param size number The size multiplier to apply to the animal
---@return Object_ID object_id The object_id of the animal that spawned
---@return boolean is_success If the function succeeded
function server.spawnCreature(matrix, animal_type, size) return object_id, is_success end

---Set the target position for a creature to pathfind and move towards.
---@param object_id Object_ID
---@param transform Transform
---@return boolean is_success
function server.setCreatureMoveTarget(object_id, transform) return is_success end

---Spawns an equipment as a dynamic object in the world.
---@param transform Transform
---@param equipment_id EQUIPMENT_ID
---@param int integer|nil integer parameter for the Equipment
---@param float number|nil float parameter for the equipment.
---@return Object_ID object_id
---@return boolean is_success
function server.spawnEquipment(transform, equipment_id, int, float) return object_id, is_success end
...
---@return boolean is_success If the function succeeded
function server.getObjectPos(object_id) return transform, is_success end
...
---Set a character or creature object to be seated on a vehicle.
...
---Set a character or creature object to be seated on a vehicle. (Alias for setSeated)
---@param object_id Object_ID The object_id of the character to teleport.
---@param vehicle_id Vehicle_ID The vehicle_id of the vehicle that the seat is a part of.
---@param seat_name? string The name of the seat to teleport the character to. If an empty string, the character will be teleported to the first seat found.
...
---@param vehicle_id Vehicle_ID The vehicle_id of the vehicle that the seat is a part of.
---@param seat_name? string The name of the seat to teleport the character to. If an empty string, the character will be teleported to the first seat found.
function server.setCreatureSeated(object_id, vehicle_id, seat_name) end


---Get data on a character object. (Alias: getCharacterData)
...
---@nodiscard
function server.getObjectData(object_id) return object_data end
...
---Set the tooltip value (name) for a non-player character.
---@param object_id Object_ID
---@param display_name string
function server.setCharacterTooltip(object_id, display_name) end

---Set the tooltip value (name) for a creature.
---@param object_id Object_ID
---@param display_name string
...
-- Note: server.spawnAddonVehicle lives with the other addon functions because that makes more organizational sense.
...
---@return boolean is_success If the function succeeded
function server.getVehiclePos(vehicle_id, voxel_x, voxel_y, voxel_z) return transform, is_success end
...
---Checks if a box of the specified size and position is clear of vehicles.
---@param transform Transform
---@param size_x number
---@param size_y number
---@param size_z number
---@return boolean is_clear
function server.isLocationClear(transform, size_x, size_y, size_z) return is_clear end

---Reloads the vehicle, resetting the vehicle as if spawned fresh from the workbench (no damage, inventories and fluids reset).
---@param vehicle_id Vehicle_ID The vehicle_id of the vehicle to reset.
---@return boolean is_success
function server.resetVehicleState(vehicle_id) return is_success end
...
--Note: server.cleanRadiation moved to region Misc because it does not belong here.
...
---@class GetVehicleSeatResult
---@field name string name of the seat.
---@field pos Vector3 Voxel position of the seat.
---@field seated_id Object_ID|nil The Id of the character or creature seated.
---@field seated_peer_id Peer_ID|nil If the character seated is controlled by a player the Peer_ID.

---Get data about a seat on the vehicle. If searching by name the first matching seat is returned.
---@param vehicle_id Vehicle_ID
---@param seat_name_or_voxel_x string|integer Either the name of a seat to find, or the voxel x (red/right) position.
---@param voxel_y nil|integer Only when searching by voxel position: the y (green/up) component.
---@param voxel_z nil|integer Only when searching by voxel position: the z (blue/forward) component.
---@return GetVehicleSeatResult
---@return boolean is_success
function server.getVehicleSeat(vehicle_id, seat_name_or_voxel_x, voxel_y, voxel_z) return seat_data, is_success end
...
---@class GetRopeHookResult
---@field name string
---@field pos Vector3

---Get data about a RopeHook on the vehicle. If searching by name the first matching RopeHook is returned.
---@param vehicle_id Vehicle_ID
---@param name_or_voxel_x string|integer Either the name of a RopeHook to find, or the voxel x (red/right) position.
---@param voxel_y nil|integer Only when searching by voxel position: the y (green/up) component.
---@param voxel_z nil|integer Only when searching by voxel position: the z (blue/forward) component.
---@return GetVehicleSeatResult
---@return boolean is_success
function server.getVehicleRopeHook(vehicle_id, name_or_voxel_x, voxel_y, voxel_z) return rope_hook_data, is_success end

---@alias ROPE_TYPE
---|0 # Rope
---|1 # Hose
---|2 # Electric Cable
---|3 # Suspension Cable (Thick Rope)

---Spawns a rope between two rope anchors on the specified vehicles at the specified voxel positions.
---@param vehicle_a_id Vehicle_ID
---@param voxel_a_x integer The voxel position (red/right)
---@param voxel_a_y integer The voxel position (green/up)
---@param voxel_a_z integer The voxel position (blue/forward)
---@param vehicle_b_id Vehicle_ID
---@param voxel_b_x integer The voxel position (red/right)
---@param voxel_b_y integer The voxel position (green/up)
---@param voxel_b_z integer The voxel position (blue/forward)
---@param length number
---@param rope_type ROPE_TYPE
function server.spawnVehicleRope(
	vehicle_a_id, voxel_a_x, voxel_a_y, voxel_a_z,
	vehicle_b_id, voxel_b_x, voxel_b_y, voxel_b_z,
	length,
	rope_type
)
end
...
---Returns wether the vehicle is loading, simulating or unloading.
---This probably means: the game wants the vehicle to be simulating (because it is close to a player).
...
local AI_states = {
	Ship_Pilot = {
		none = 0,
		path_to_destination = 1,
	},
	Helicopter_Pilot = {
		none = 0,
		path_to_destination = 1,
		path_to_destination_accurate = 2,
		gun_run = 3,
	},
	Plane_Pilot = {
		none = 0,
...
---|0 main_menu (cannot be set)
---|0 normal
---|0 mission_mid
---|0 mission_high

---Set the target audio mood. Mood naturally decreases over time.
---@param peer_id Peer_ID player to set mood, -1 for all players.
---@param mood AUDIO_MOOD
function server.setAudioMood(peer_id, mood) end
...
---Returns the generated ocean floor height of a tile. This is not the height of the terrain, and does not include any meshes.
---@param transform Transform
---@return number height The sea floor height relative to sea level (so typical values will be less than 1).
function server.getOceanFloor(transform) return height end
...
---@class OilDeposit
---@field x number position
---@field y number position
---@field z number position
---@field r number radius
---@field oil number amount of oil in the deposit.

---Returns a list of oil deposits.
---@return OilDeposit[]
function server.getOilDeposits() return deposits end
...
function server.httpGet(port, request)
	print(string.format("server.httpGet(%s, %s)", port, request))
end
...
function server.getTimeMillisec()
	time_since_load = time_since_load + 1
