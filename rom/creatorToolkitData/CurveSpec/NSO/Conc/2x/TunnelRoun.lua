...
do -- Create Embankment
	...
	local extrusion = Tunnel({Colour = Color255(77, 77, 62, 255), WallColour = Color255(80, 80, 80, 255), Shape = "Rounded", ShapeParam = 2.5, Width = 10.5, Height = 10, YOffset = -0.25 }, ISet)
