...
--------------------------------------------------------------------------------
	do -- Create lines for Physics
		for i, vi in ipairs(physVertexIndices) do
			if i == 1 then
				-- The start of the first line
				set.PhysLineIndices:Add(vi)
			else
				-- The end of a line
				set.PhysLineIndices:Add(vi)
		...
		-- The end of the last line, going back to the first vertex.
		set.PhysLineIndices:Add(physVertexIndices[1])
	end
...
--------------------------------------------------------------------------------
	...
	for i = 0, physIndicesPerRail - 1, 2 do
		--print(set.PhysLineIndices[i    ] , set.PhysLineIndices[i + 1])

		-- Indices are reversed, yes this matters for physics too.
		-- If it's the wrong way round a wall will suck you to the other side of itself.
		-- and a floor will make you fall through (but not allow you to jump back up).
